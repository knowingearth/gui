...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws WriterException, IOException {
        String s = generateQRCodeBase64("央广购物");
     ...
     * @throws IOException
     */
    public static String generateQRCodeBase64(String msg) throws WriterException, IOException {
        ...
        BitMatrix bitMatrix = multiFormatWriter.encode(msg, BarcodeFormat.QR_CODE, CODE_WIDTH, CODE_HEIGHT, typeObjectHashMap);
        ...
        insertLogoImage(bufferedImage, QRCodeUtil.class.getResourceAsStream("/pdf/files/LOGO_WITH_BORDER.png"));
